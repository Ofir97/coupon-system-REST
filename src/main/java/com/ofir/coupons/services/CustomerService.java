...
public class CustomerService extends ClientService {
	...
	public List<Coupon> getCustomerCoupons()  {
		return couponsRepository.getCustomerCoupons(customerID);
	}
	...
	public List<Coupon> getCustomerCoupons(Category category) {
		return couponsRepository.getCustomerCouponsByCategoryId(customerID, category.getId());
	}
	...
	public List<Coupon> getCustomerCoupons(double maxPrice) {
		return couponsRepository.getCustomerCouponsUntilMaxPrice(customerID, maxPrice);
	}
